...
public class CustomSeekBar extends View {
    ...
    protected static final int DEFAULT_CIRCLE_PROGRESS_START_COLOR = Color.TRANSPARENT;
    protected static final int DEFAULT_CIRCLE_PROGRESS_END_COLOR = Color.TRANSPARENT;
    ...
    /**
     * Start angle of the CustomSeekBar.
    ...
    /**
     * End angle of the CustomSeekBar.
     * Note: If mStartAngle and mEndAngle are set to the same angle, 0.1 is subtracted
     * from the mEndAngle to make the circle function properly.
     */
    ...
    /**
     * Max value that this CustomSeekBar is representing.
     */
    protected int mMax;

    /**
     * Progress value that this CustomSeekBar is representing.
     */
    protected int mProgress;

    /**
     * If true, then the user can specify the X and Y radii.
     * If false, then the View itself determines the size of the CustomSeekBar.
     */
     ...
     * Used when touching the CustomSeekBar.
     */
    ...
    /**
     * Initialize the CustomSeekBar with the attributes from the XML style.
...
//        int pixel = (int) Color.red(mPointerPositionXY[0], mPointerPositionXY[1]);
    ...
    /**
     * Get the progress of the CustomSeekBar.
     *
     * @return The progress of the CustomSeekBar.
     */
    ...
    /**
     * Set the progress of the CustomSeekBar.
     * If the progress is the same, then any listener will not receive a onProgressChanged event.
     *
     * @param progress The progress to set the CustomSeekBar to.
     */
    ...
    /**
     * Listener for the CustomSeekBar. Implements the same methods as the normal OnSeekBarChangeListener.
     */
    public interface OnCircularSeekBarChangeListener {

        public abstract void onProgressChanged(CustomSeekBar CustomSeekBar, int progress, boolean fromUser);
    ...
    /**
     * Set the max of the CustomSeekBar.
     ...
     *
     * @param max The new max for the CustomSeekBar.
     */
    ...
    /**
     * Get the current max of the CustomSeekBar.
     *
